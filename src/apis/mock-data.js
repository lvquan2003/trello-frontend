  ...
  board: {
    ...
    columns: [
      ...
      },
      {
        ...
        //Phía FE sẽ  tự tạo ra một card đặc biệt : Placeholder card, không liên quan tới BE.
        //
        cardOrderIds: ['card-id-111'],
        cards: [
          { _id: 'card-id-111', boardId: 'board-id-01', columnId: 'column-id-04-placeholder-card', FE_PlaceholderCard: true }
        ]
      }
    ]
  }
